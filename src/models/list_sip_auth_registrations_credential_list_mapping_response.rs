...
pub struct ListSipAuthRegistrationsCredentialListMappingResponse {
    #[serde(rename = "contents", skip_serializing_if = "Option::is_none")]
    pub contents: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthRegistrationsPeriodSipAuthRegistrationsCredentialListMapping>>,
...
impl ListSipAuthRegistrationsCredentialListMappingResponse {
    pub fn new() -> ListSipAuthRegistrationsCredentialListMappingResponse {
