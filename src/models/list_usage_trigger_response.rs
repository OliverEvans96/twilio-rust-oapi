...
pub struct ListUsageTriggerResponse {
    #[serde(rename = "usage_triggers", skip_serializing_if = "Option::is_none")]
    pub usage_triggers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageTrigger>>,
