...
pub struct ListAvailablePhoneNumberSharedCostResponse {
    ...
    pub available_phone_numbers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodAvailablePhoneNumberCountryPeriodAvailablePhoneNumberSharedCost>>,
...
impl ListAvailablePhoneNumberSharedCostResponse {
    pub fn new() -> ListAvailablePhoneNumberSharedCostResponse {
