...
pub struct ListCallRecordingResponse {
    ...
    pub recordings: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodCallPeriodCallRecording>>,
...
impl ListCallRecordingResponse {
    pub fn new() -> ListCallRecordingResponse {
