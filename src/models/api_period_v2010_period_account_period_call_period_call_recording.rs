...
pub struct ApiPeriodV2010PeriodAccountPeriodCallPeriodCallRecording {
    ...
    #[serde(rename = "track", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
