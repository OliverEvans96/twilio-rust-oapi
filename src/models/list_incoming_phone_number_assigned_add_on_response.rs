...
pub struct ListIncomingPhoneNumberAssignedAddOnResponse {
    #[serde(rename = "assigned_add_ons", skip_serializing_if = "Option::is_none")]
    pub assigned_add_ons: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumberPeriodIncomingPhoneNumberAssignedAddOn>>,
...
impl ListIncomingPhoneNumberAssignedAddOnResponse {
    pub fn new() -> ListIncomingPhoneNumberAssignedAddOnResponse {
        ListIncomingPhoneNumberAssignedAddOnResponse {
            assigned_add_ons: None,
            end: None,
            first_page_uri: None,
            next_page_uri: None,
            page: None,
