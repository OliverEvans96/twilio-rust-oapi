...
pub struct ListIncomingPhoneNumberAssignedAddOnExtensionResponse {
    #[serde(rename = "extensions", skip_serializing_if = "Option::is_none")]
    pub extensions: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumberPeriodIncomingPhoneNumberAssignedAddOnPeriodIncomingPhoneNumberAssignedAddOnExtension>>,
...
impl ListIncomingPhoneNumberAssignedAddOnExtensionResponse {
    pub fn new() -> ListIncomingPhoneNumberAssignedAddOnExtensionResponse {
