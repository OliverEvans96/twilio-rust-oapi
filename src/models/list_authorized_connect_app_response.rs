...
pub struct ListAuthorizedConnectAppResponse {
    #[serde(rename = "authorized_connect_apps", skip_serializing_if = "Option::is_none")]
    pub authorized_connect_apps: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodAuthorizedConnectApp>>,
