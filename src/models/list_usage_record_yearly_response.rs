...
pub struct ListUsageRecordYearlyResponse {
    ...
    pub usage_records: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageRecordPeriodUsageRecordYearly>>,
...
impl ListUsageRecordYearlyResponse {
    pub fn new() -> ListUsageRecordYearlyResponse {
