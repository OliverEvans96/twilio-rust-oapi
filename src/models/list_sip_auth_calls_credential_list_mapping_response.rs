...
pub struct ListSipAuthCallsCredentialListMappingResponse {
    ...
    pub contents: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsCredentialListMapping>>,
...
impl ListSipAuthCallsCredentialListMappingResponse {
    pub fn new() -> ListSipAuthCallsCredentialListMappingResponse {
