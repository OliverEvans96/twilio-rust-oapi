...
pub struct ListUsageRecordTodayResponse {
    ...
    pub usage_records: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageRecordPeriodUsageRecordToday>>,
...
impl ListUsageRecordTodayResponse {
    pub fn new() -> ListUsageRecordTodayResponse {
