...
pub struct ListUsageRecordLastMonthResponse {
    ...
    pub usage_records: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageRecordPeriodUsageRecordLastMonth>>,
...
impl ListUsageRecordLastMonthResponse {
    pub fn new() -> ListUsageRecordLastMonthResponse {
