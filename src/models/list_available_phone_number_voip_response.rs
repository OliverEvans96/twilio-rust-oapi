...
pub struct ListAvailablePhoneNumberVoipResponse {
    ...
    pub available_phone_numbers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodAvailablePhoneNumberCountryPeriodAvailablePhoneNumberVoip>>,
...
impl ListAvailablePhoneNumberVoipResponse {
    pub fn new() -> ListAvailablePhoneNumberVoipResponse {
