...
pub struct ListOutgoingCallerIdResponse {
    #[serde(rename = "outgoing_caller_ids", skip_serializing_if = "Option::is_none")]
    pub outgoing_caller_ids: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodOutgoingCallerId>>,
