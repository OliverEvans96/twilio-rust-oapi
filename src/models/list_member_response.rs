...
pub struct ListMemberResponse {
    #[serde(rename = "queue_members", skip_serializing_if = "Option::is_none")]
    pub queue_members: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodQueuePeriodMember>>,
