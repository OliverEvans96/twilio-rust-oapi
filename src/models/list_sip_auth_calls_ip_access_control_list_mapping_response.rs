...
pub struct ListSipAuthCallsIpAccessControlListMappingResponse {
    ...
    pub contents: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsIpAccessControlListMapping>>,
