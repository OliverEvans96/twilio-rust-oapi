...
pub struct ListSipCredentialListMappingResponse {
    #[serde(rename = "credential_list_mappings", skip_serializing_if = "Option::is_none")]
    pub credential_list_mappings: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipCredentialListMapping>>,
...
impl ListSipCredentialListMappingResponse {
    pub fn new() -> ListSipCredentialListMappingResponse {
        ListSipCredentialListMappingResponse {
            credential_list_mappings: None,
            end: None,
            first_page_uri: None,
            next_page_uri: None,
            page: None,
