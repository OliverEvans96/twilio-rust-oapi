...
pub struct ListAvailablePhoneNumberLocalResponse {
    ...
    pub available_phone_numbers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodAvailablePhoneNumberCountryPeriodAvailablePhoneNumberLocal>>,
...
impl ListAvailablePhoneNumberLocalResponse {
    pub fn new() -> ListAvailablePhoneNumberLocalResponse {
