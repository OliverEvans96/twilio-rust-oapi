...
pub struct ListDependentPhoneNumberResponse {
    #[serde(rename = "dependent_phone_numbers", skip_serializing_if = "Option::is_none")]
    pub dependent_phone_numbers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodAddressPeriodDependentPhoneNumber>>,
...
impl ListDependentPhoneNumberResponse {
    pub fn new() -> ListDependentPhoneNumberResponse {
        ListDependentPhoneNumberResponse {
            dependent_phone_numbers: None,
            end: None,
            first_page_uri: None,
            next_page_uri: None,
            page: None,
