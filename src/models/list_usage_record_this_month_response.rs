...
pub struct ListUsageRecordThisMonthResponse {
    ...
    pub usage_records: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageRecordPeriodUsageRecordThisMonth>>,
...
impl ListUsageRecordThisMonthResponse {
    pub fn new() -> ListUsageRecordThisMonthResponse {
