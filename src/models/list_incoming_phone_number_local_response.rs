...
pub struct ListIncomingPhoneNumberLocalResponse {
    ...
    pub incoming_phone_numbers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumberPeriodIncomingPhoneNumberLocal>>,
...
impl ListIncomingPhoneNumberLocalResponse {
    pub fn new() -> ListIncomingPhoneNumberLocalResponse {
