...
pub struct ListUsageRecordYesterdayResponse {
    ...
    pub usage_records: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodUsagePeriodUsageRecordPeriodUsageRecordYesterday>>,
...
impl ListUsageRecordYesterdayResponse {
    pub fn new() -> ListUsageRecordYesterdayResponse {
