...
pub struct ListSipIpAccessControlListResponse {
    #[serde(rename = "ip_access_control_lists", skip_serializing_if = "Option::is_none")]
    pub ip_access_control_lists: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipIpAccessControlList>>,
...
impl ListSipIpAccessControlListResponse {
    pub fn new() -> ListSipIpAccessControlListResponse {
