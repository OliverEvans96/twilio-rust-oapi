...
pub struct ListIncomingPhoneNumberResponse {
    ...
    pub incoming_phone_numbers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumber>>,
...
impl ListIncomingPhoneNumberResponse {
    pub fn new() -> ListIncomingPhoneNumberResponse {
