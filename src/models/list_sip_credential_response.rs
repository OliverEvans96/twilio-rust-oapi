...
pub struct ListSipCredentialResponse {
    ...
    pub credentials: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipCredentialListPeriodSipCredential>>,
...
impl ListSipCredentialResponse {
    pub fn new() -> ListSipCredentialResponse {
