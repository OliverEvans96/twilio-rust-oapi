...
pub struct ListAvailablePhoneNumberMachineToMachineResponse {
    ...
    pub available_phone_numbers: Option<Vec<crate::models::ApiPeriodV2010PeriodAccountPeriodAvailablePhoneNumberCountryPeriodAvailablePhoneNumberMachineToMachine>>,
